...
const mediaJobs = [
  ...
  {
    id: 'mj_3',
    fileName: 'ATTT_Highlights_CutPlan.mp4',
    documentId: 'd_1',
    rootAssetId: 'asset_1',
    projectId: 'p_1',
  ...
  {
    id: 'mj_5',
    fileName: 'Software_Walkthrough_OriginalAudio.mp4',
    documentId: 'd_2',
    rootAssetId: 'asset_2',
    projectId: 'p_1',
    processingMode: 'TRANSLATE_ONLY',
    ...
    stages: [
      ...
      makeStage('SOURCE_SEPARATION', 2, 'SKIPPED'),
      makeStage('STT', 3, 'COMPLETED'),
      makeStage('SUMMARIZE', 4, 'SKIPPED'),
      makeStage('TRANSLATE', 5, 'COMPLETED'),
      makeStage('TTS', 6, 'SKIPPED'),
      makeStage('AUDIO_MIX', 7, 'COMPLETED'),
      makeStage('RENDER', 8, 'COMPLETED', { outputRef: 'Software_Walkthrough_OriginalAudio_sub.mp4' }),
    ],
  },
  {
    id: 'mj_6',
    fileName: 'AI_Trends_Shorts_9x16.mp4',
    documentId: 'd_2',
    rootAssetId: 'asset_2',
    projectId: 'p_1',
    processingMode: 'TRANSLATE_ONLY',
    ...
    selectedProposalId: 'prop_2',
    translationJobId: 'jtxt_5',
    ttsProviderId: 'prov_1',
    ttsVoiceId: 'voice_4',
    ...
    stages: [
      ...
      makeStage('TTS', 6, 'COMPLETED'),
      makeStage('AUDIO_MIX', 7, 'COMPLETED'),
      makeStage('RENDER', 8, 'COMPLETED', { outputRef: 'AI_Trends_Shorts_9x16_final.mp4' }),
    ],
  },
]
