...
/**
 * Summarization proposal & refine (API_Contract.md §5.1). The first AI proposal is generated by the
 * SUMMARIZE pipeline stage; this controller exposes selection and refinement of persisted proposals.
 */
@RestController
